...
namespace Io.Blockmate.Model
{
    ...
    public partial class Amount :  IEquatable<Amount>, IValidatableObject
    {
        ...
        public Amount(decimal value = default(decimal), string currency = default(string), string currencyName = default(string), string currencySymbol = default(string), string imageName = default(string), string imageUrl = default(string), string convertedCurrency = default(string), decimal convertedValue = default(decimal))
        {
