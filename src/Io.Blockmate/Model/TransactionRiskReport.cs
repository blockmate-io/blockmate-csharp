...
namespace Io.Blockmate.Model
{
    ...
    public partial class TransactionRiskReport :  IEquatable<TransactionRiskReport>, IValidatableObject
    {
        ...
        public TransactionRiskReport(string caseId = default(string), string requestDatetime = default(string), string responseDatetime = default(string), string transaction = default(string), string chain = default(string), int risk = default(int), Dictionary<string, TransactionRiskReportDetailsValue> details = default(Dictionary<string, TransactionRiskReportDetailsValue>))
        {
        ...
        public Dictionary<string, TransactionRiskReportDetailsValue> Details { get; set; }
