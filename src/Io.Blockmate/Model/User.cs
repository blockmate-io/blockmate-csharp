...
namespace Io.Blockmate.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(string uuid = default(string), string name = default(string))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new InvalidDataException("uuid is a required property for User and cannot be null");
            }
            else
            {
                this.Uuid = uuid;
