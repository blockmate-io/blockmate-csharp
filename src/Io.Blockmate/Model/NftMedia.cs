...
namespace Io.Blockmate.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NftMedia :  IEquatable<NftMedia>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NftMedia" /> class.
        /// </summary>
        ...
        public NftMedia(string raw = default(string), string gateway = default(string), string thumbnail = default(string), string format = default(string), int bytes = default(int))
        {
            this.Raw = raw;
        ...
        {
            return this.Equals(input as NftMedia);
        }

        /// <summary>
        /// Returns true if NftMedia instances are equal
        /// </summary>
        /// <param name="input">Instance of NftMedia to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NftMedia input)
        {
            if (input == null)
                return false;
