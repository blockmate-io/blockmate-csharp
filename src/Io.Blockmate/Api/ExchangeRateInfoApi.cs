...
namespace Io.Blockmate.Api
{
    ...
    public interface IExchangeRateInfoApi : IApiAccessor
    {
        ...
        /// <param name="pairs">Currency pairs for which exchange rate should be returned</param>
        ...
        /// <param name="days">Historical dates for which exchange rates should be returned</param>
        /// <returns>List<ExchangeRate></returns>
