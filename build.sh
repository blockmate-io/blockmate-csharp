...
${nuget_cmd} install src/Io.Blockmate/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Io.Blockmate.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Io.Blockmate.dll \
-recurse:'src/Io.Blockmate/*.cs' \
-doc:bin/Io.Blockmate.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Io.Blockmate.dll was created successfully"
fi
